...
class _BNode(object):
    __slots__ = ["tree", "contents", "children","typeTree"]

    def __init__(self, tree, contents=None, children=None, typeTree = None):
        self.tree = tree
        self.contents = contents or []
        self.children = children or []
        self.typeTree = typeTree or []
        if self.children:
    ...
    def shrink(self, ancestors):
        ...
        parent.typeTree.insert(parent_index, push)
    ...
    def split(self):
        ...
        sibling = type(self)(
                ...
                self.typeTree[center + 1:],
                self.children[center + 1:])
        self.contents = self.contents[:center]
        self.typeTree = self.typeTree[:center]
        self.children = self.children[:center + 1]
        return sibling, median

    def insert(self, index, item, ancestors, t=None):
    ...
    def remove(self, index, ancestors):
        ...
        if self.children:
            ...
            if len(descendent.contents) > minimum:
                ...
                self.typeTree[index] = descendent.typeTree[0]
            ...
            self.typeTree[index] = descendent.typeTree[-1]
            descendent.remove(len(descendent.children) - 1, ancestors)
        else:
            self.contents.pop(index)
            self.typeTree.pop(index)
...
class BTree(object):
    ...
    def insert(self, item, t=None):
        ...
        node.insert(index, item, ancestors,t)
            ...
            if node.children:
                for child, item in zip(node.children, node.contents):
                    for child_item in _recurse(child):
                        yield child_item
                    yield item
                for child, item in zip(node.children, node.typeTree):
                    for child_item in _recurse(child):
                        yield child_item
                    yield item
